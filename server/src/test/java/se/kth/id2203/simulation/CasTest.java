 ...
 * Creates a client which send a compare and swap operation to the server
 */
public class CasTest extends ComponentDefinition {
    final static Logger LOG = LoggerFactory.getLogger(CasTest.class);
    //******* Ports ******
    ...
    protected final Handler<Start> startHandler = new Handler<Start>() {
        ...
        public void handle(Start event) {
            ...
            Operation op = new CASOperation(self, "4", "FOO", "BAR");
